...
\begin{frame}{Metodi a varianza ridotta: l'idea comune}
  \begin{itemize}
    \item SVRG (Johnson--Zhang, 2013) e SAGA (Defazio--Bach--Lacoste-Julien,
      2014): SGD + \emph{correzione} costruita su quantità globali.
    ...
    \item Differenza chiave tra i due metodi:
      ...
      \end{itemize}
    \item Ricompensa: convergenza \emph{lineare} su problemi fortemente
      convessi anche con passo costante.
  \end{itemize}
...
% =====================================================================
% SLIDE 8 — Limiti di SVRG/SAGA e lezione per la tesi
% =====================================================================
