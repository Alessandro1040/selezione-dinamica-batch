...
% =====================================================================
% SLIDE 21 — Newton-CG L1: z_k, active set e faccia ortante (eq. 5.43-5.46)
% =====================================================================
\begin{frame}{Newton-CG $L_1$: $z_k$, active set e faccia ortante}
  ...
  \setlength{\belowdisplayshortskip}{2pt}
  \begin{itemize}\setlength{\itemsep}{1pt}
    \item $F=J+\nu\|w\|_1$ non è differenziabile dove $w_i=0$: l'algoritmo
      decide se \emph{liberare} $w_i$ o \emph{attivarla} (tenerla a zero, per
      la sparsità). La decisione è codificata da $z_k\in\{-1,0,+1\}^m$
      (eq.~5.44):
      \[
        z_k^i=\begin{cases}
...
% =====================================================================
% SLIDE 22 — Newton-CG L1: ricerca lineare proiettata (eq. 5.49-5.50)
% =====================================================================
...
% =====================================================================
% SLIDE 23 — Schema: Newton-CG L1 (Fig. 5.5)
% =====================================================================
...
% =====================================================================
% SLIDE 24 — Il passo di Barzilai--Borwein (1/2): relazione secante e passo
% =====================================================================
...
% =====================================================================
% SLIDE 25 — Barzilai--Borwein (2/2): le due formule e la salvaguardia
% =====================================================================
...
% =====================================================================
% SLIDE 26 — Schema: BB-CCV (Fig. 5.6)
% =====================================================================
...
\end{frame}
% =====================================================================
% SLIDE 28 — Le funzioni test: espressioni usate negli esperimenti
% =====================================================================
...
% =====================================================================
% SLIDE 29 — Setup e risultati numerici
% =====================================================================
...
% =====================================================================
% SLIDE 30 — Riuso del mini-batch (Sez. 6.5)
% =====================================================================
...
% =====================================================================
% SLIDE 31 — Cosa significa riusare il batch
% =====================================================================
...
% =====================================================================
% SLIDE 32 -- Riuso del mini-batch: sintesi dei risultati (Tab.6.1)
% =====================================================================
...
% =====================================================================
% SLIDE 33 -- Robustezza del riuso su 5 seed indipendenti (Tab.6.2)
% =====================================================================
...
% =====================================================================
% SLIDE 34 — Stop adattivo con validation set: come funziona
% =====================================================================
...
% =====================================================================
% SLIDE 35 -- Stop adattivo con validation set (Tab.6.3)
% =====================================================================
...
% =====================================================================
% SLIDE 36 — Riuso per discesa della loss sul batch: come funziona
% =====================================================================
...
% =====================================================================
% SLIDE 37 -- In alternativa: riuso per discesa della loss sul batch (Tab.6.5)
% =====================================================================
...
% =====================================================================
% SLIDE 38 -- Confronto finale su 5 seed: base, $M{=}\infty$, validation e discesa (Tab.6.7)
% =====================================================================
...
% =====================================================================
% SLIDE 40 — Limiti e lavoro futuro
% =====================================================================
