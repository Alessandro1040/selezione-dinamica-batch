...
% =====================================================================
% SLIDE 13 — Il passo $\alpha_k$: condizioni di Armijo e Wolfe (App.~A)
% =====================================================================
\begin{frame}{Il passo $\alpha_k$: condizioni di Armijo e Wolfe}
  \footnotesize
  \setlength{\abovedisplayskip}{2pt}
  \setlength{\belowdisplayskip}{2pt}
  \setlength{\abovedisplayshortskip}{2pt}
  ...
  \begin{itemize}\setlength{\itemsep}{1pt}
    \item Il passo $\alpha_k$ è scelto da una \emph{line search} lungo la
      direzione di discesa $p$ ($\nabla f(x_k)^Tp<0$): $\alpha$ deve ridurre
      $f$ in modo ``sufficiente'', senza essere troppo piccolo. Condizioni
      usate dagli algoritmi (Appendice~A, ``Spiegazione delle condizioni sul
      passo $\alpha_k$'').
    \item \textbf{Armijo} --- limite \emph{superiore} su $f$ lungo $p$: il passo
      è accettato se $f(x_k+\alpha p)$ sta sotto la retta
      $f(x_k)+c_1\alpha\,\nabla f(x_k)^Tp$:
      \[
        f(x_k+\alpha p)\;\le\;f(x_k)+c_1\,\alpha\,\nabla f(x_k)^Tp,
        \qquad c_1\in(0,1)\ \ (\text{tip. }10^{-4}),
      \]
      la retta ha pendenza $c_1\nabla f(x_k)^Tp$, meno ripida della tangente in
      $\alpha=0$: i passi che la superano vengono rifiutati e ridotti
      (impedisce i passi \emph{troppo grandi}).
    \item \textbf{Wolfe} --- condizione di \emph{curvatura}, limite
      \emph{inferiore} sulla derivata lungo la direzione. Con
      ...
      \[
        ...
        \qquad g'(0)=\nabla f(x_k)^Tp<0,
      \]
      poiché $c_2<1$, $c_2g'(0)$ è meno negativo di $g'(0)$: la condizione
      scarta i passi \emph{troppo piccoli} (per $\alpha\to0^+$,
      $g'(\alpha)\to g'(0)$, che viola la disuguaglianza).
    \item $0<c_1<c_2<1$ rende le due condizioni \emph{compatibili} (intervallo
      non vuoto di $\alpha$ accettabili); se $c_1\ge c_2$ le condizioni
      possono diventare contraddittorie.
  \end{itemize}
  \fonte{Dalla tesi --- Appendice~A; nei codici (Appendice~B): Wolfe con
    $c_1{=}10^{-4}$, $c_2{=}0.9$ per Dynamic GD e Newton-CG; Armijo con
    backtracking per BB-CCV; Armijo proiettata per Newton-CG~$L_1$}
\end{frame}
...
\begin{frame}{Newton-CG: non serve un residuo più piccolo dell'errore di Hessiana}
  ...
  \begin{itemize}\setlength{\itemsep}{0pt}
    ...
    \item \textbf{Perché non è calcolabile?} $\Delta_{\mathcal{H}_k}$ contiene
      ...
      per l'errore $e_k$ del gradiente: stima con la \textbf{varianza
      campionaria} dei prodotti Hessiana--vettore su $\mathcal{H}_k$ (prossima
      slide).
  \end{itemize}
...
% SLIDE 21 — Newton-CG L1: cos'è z_k e perché la line search proiettata
% =====================================================================
...
% =====================================================================
% SLIDE 22 — Schema: Newton-CG L1 (Fig. 5.5)
% =====================================================================
...
% =====================================================================
% SLIDE 23 — Il passo di Barzilai--Borwein (1/2): relazione secante e passo
% =====================================================================
...
% =====================================================================
% SLIDE 24 — Barzilai--Borwein (2/2): le due formule e la salvaguardia
% =====================================================================
...
% =====================================================================
% SLIDE 25 — Schema: BB-CCV (Fig. 5.6)
% =====================================================================
...
\end{frame}
% =====================================================================
% SLIDE 27 — Le funzioni test: espressioni usate negli esperimenti
% =====================================================================
...
% =====================================================================
% SLIDE 28 — Setup e risultati numerici
% =====================================================================
...
% =====================================================================
% SLIDE 29 — Riuso del mini-batch (Sez. 6.5)
% =====================================================================
...
% =====================================================================
% SLIDE 30 — Cosa significa riusare il batch
% =====================================================================
...
% =====================================================================
% SLIDE 31 -- Riuso del mini-batch: sintesi dei risultati (Tab.6.1)
% =====================================================================
...
% =====================================================================
% SLIDE 32 -- Robustezza del riuso su 5 seed indipendenti (Tab.6.2)
% =====================================================================
...
% =====================================================================
% SLIDE 33 — Stop adattivo con validation set: come funziona
% =====================================================================
...
% =====================================================================
% SLIDE 34 -- Stop adattivo con validation set (Tab.6.3)
% =====================================================================
...
% =====================================================================
% SLIDE 35 — Riuso per discesa della loss sul batch: come funziona
% =====================================================================
\begin{frame}{Riuso per discesa della loss sul batch: come funziona}
  ...
  \setlength{\belowdisplayshortskip}{2pt}
  \begin{itemize}\setlength{\itemsep}{2pt}
    \item Stesso obiettivo dello stop adattivo --- capire quando il batch è
      ``esaurito'' --- ma \textbf{senza riservare dati}: si osserva solo la
      loss sul mini-batch corrente, campionato dall'\emph{intero} dataset
      (CCV con tetto $N$).
  ...
  \begin{enumerate}\setlength{\itemsep}{1pt}
    ...
    \item Se per $P$ valutazioni consecutive \emph{non} c'è progresso
      $\Rightarrow$ \textbf{ricampiona} (batch ``esaurito''); $\tau$ più alta
      (es. $10^{-3}$) dichiara il batch esaurito prima.
  \end{enumerate}
...
% =====================================================================
% SLIDE 36 -- In alternativa: riuso per discesa della loss sul batch (Tab.6.5)
% =====================================================================
...
% =====================================================================
% SLIDE 37 -- Confronto finale su 5 seed: base, $M{=}\infty$, validation e discesa (Tab.6.7)
% =====================================================================
...
% =====================================================================
% SLIDE 39 — Limiti e lavoro futuro
% =====================================================================
