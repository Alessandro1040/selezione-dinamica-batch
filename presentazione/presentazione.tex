...
\begin{frame}{La varianza del gradiente stimato: definizioni}
  ...
  \begin{itemize}\setlength{\itemsep}{4pt}
    ...
    \item Definizione (``v-hat''): la stima si ottiene dalla varianza
      \emph{campionaria} dei gradienti per-esempio sul batch corrente,
      centrata sulla media campionaria $g_k$:
      \[
        \widehat{\mathcal{V}}
        := \frac{1}{n_k-1}\sum_{i\in\mathcal{S}_k}
        \bigl(\nabla\ell(w_k;i)-g_k\bigr)^2\in\mathbb{R}^m ,
      \]
      quadrato e divisione componente per componente; il denominatore
      $n_k-1$ (Bessel) rende la stima non distorta.
  \end{itemize}
