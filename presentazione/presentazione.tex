...
\begin{frame}{Newton-CG: non serve un residuo più piccolo dell'errore di Hessiana}
  ...
  \begin{itemize}\setlength{\itemsep}{2pt}
    ...
    \item \textbf{Perché un arresto adattivo:} l'obiettivo è \emph{bilanciare}
      i due termini della decomposizione. Poiché $\Delta_{\mathcal{H}_k}$ non è
      calcolabile direttamente (servirebbero i prodotti Hessiana--vettore su
      $\mathcal{S}_k$), lo si \textbf{stima con la varianza campionaria} su
      $\mathcal{H}_k$: da qui nasce la soglia del test di arresto.
  \end{itemize}
  \fonte{Dalla tesi --- Sez.~5.2, eq.~5.33--5.35 e discussione del criterio}
\end{frame}
