...
\begin{frame}{La varianza del gradiente stimato: definizioni}
  ...
  \begin{itemize}\setlength{\itemsep}{2pt}
    \item Il gradiente sul batch è la \emph{media} dei gradienti per-esempio,
      ...
      $e_k:=g_k-\nabla J(w_k)$ non è calcolabile, perché $\nabla J(w_k)$ è
      ignoto.
    \item Quantità che si può controllare: la \emph{varianza dello
      stimatore}, $\mathbb{E}[\|e_k\|_2^2]=\|\mathrm{Var}(g_k)\|_1$ (somma
      componente per componente).
    \item $\mathcal{V}$ = varianza \emph{della popolazione} (non calcolabile:
      servirebbe $\nabla J(w_k)$); $\widehat{\mathcal{V}}$ = stima
      \emph{campionaria} sul batch corrente, centrata su $g_k$:
      \[
    ...
    \item \textbf{Doppia divisione per $n_k$}: $n_k-1$ (Bessel) rende
      $\widehat{\mathcal{V}}$ non distorto
      ($\mathbb{E}[\widehat{\mathcal{V}}]=\mathcal{V}$), stima della
      \emph{dispersione dei singoli gradienti} del batch; $g_k$ è la loro
      \emph{media}, la cui varianza è quella dei singoli \emph{divisa per
      $n_k$}:
      $\mathrm{Var}(g_k)=\mathcal{V}/n_k\approx\widehat{\mathcal{V}}/n_k$,
      quindi $\|\mathrm{Var}(g_k)\|_1\approx\|\widehat{\mathcal{V}}\|_1/n_k$
      ($=\mathbb{E}[\|e_k\|_2^2]$) è la varianza dello stimatore che la CCV
      controlla (slide successiva).
  \end{itemize}
...
% =====================================================================
% SLIDE 27 -- Riuso del mini-batch: sintesi dei risultati (Tab.6.1)
% =====================================================================
...
% =====================================================================
% SLIDE 28 -- Robustezza del riuso su 5 seed indipendenti (Tab.6.2)
% =====================================================================
...
% =====================================================================
% SLIDE 29 -- Stop adattivo con validation set (Tab.6.3)
% =====================================================================
...
\bottomrule
  ...
  \end{center}
  \fonte{Dalla tesi --- Sez.~6.5.6 e Tab.~6.3 (seed 42): tra parentesi il numero di ricampionamenti su 30 iterazioni.}
\end{frame}

% =====================================================================
% SLIDE 30 -- In alternativa: riuso per discesa della loss sul batch (Tab.6.5)
% =====================================================================
...
\bottomrule
  ...
  \end{center}
  \fonte{Dalla tesi --- Sez.~6.5.7 e Tab.~6.5 (seed 42): tra parentesi il numero di ricampionamenti su 30 iterazioni.}
\end{frame}

% =====================================================================
% SLIDE 31 -- Confronto finale su 5 seed: base, $M{=}\infty$, validation e discesa (Tab.6.7)
% =====================================================================
...
\bottomrule
  ...
  \end{center}
  \fonte{Dalla tesi --- Sez.~6.5.6--6.5.7 e Tab.~6.7: confronto dei due criteri automatici calibrati su 5 seed.}
\end{frame}
