...
val_min_abs = 0
val_strategy = 'fixed'
history, batch_sizes, resize_points, m_actual, val_hist = dynamic_gd(w0, theta, max_iter, alpha, batch0, val_pct, val_tol, val_patience, val_freq, val_min_abs, val_strategy)
