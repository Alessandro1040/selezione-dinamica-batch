...
\textbf{backpropagation}: dopo il forward si definisce l'errore
...
\begin{tikzpicture}[
  ...
  \node[box, below=of err] (bp) {Backpropagation\\[2pt] $\delta_2 = (\delta W_3^{\top}) \odot (1-a_2^2)$\\[1pt] $\delta_1 = (\delta_2 W_2^{\top}) \odot (1-a_1^2)$};
...
\end{tikzpicture}}
\caption{Calcolo vettorizzato del gradiente sul batch (backpropagation):
