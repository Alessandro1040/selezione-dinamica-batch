...
La regolarizzazione $L_1$ produce soluzioni sparse ed è uno strumento
...
soft thresholding, usato nei metodi proximali (ad esempio ISTA e FISTA
...
efficace è rappresentata dai metodi a active set e dalle strategie di
ottimizzazione su facce ortanti: si identifica l'insieme delle variabili
...
osservabile direttamente, essi lo stimano tramite la varianza campionaria
