...
$\kappa = L/\lambda$ & sovrastima del numero di condizionamento (il numero di condizionamento della Hessiana è $\lambda_{\max}/\lambda_{\min}$, cfr. Sez.~\ref{sec:formulazione}) \\
