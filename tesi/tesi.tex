...
\caption{Robustezza del riuso del mini-batch su 5 seed indipendenti ($\{42,7,123,2024,999\}$). Per ogni coppia problema--algoritmo e per ciascuna politica di riuso ($M{=}\infty$ e $M{=}10$) le tre colonne \emph{Migl.}, \emph{Pegg.} e \emph{Uguale} riportano il numero di seed su 5 in cui l'errore finale $e_{30}$, rispetto alla colonna \emph{base} della Tabella~\ref{tab:riuso_sintesi}, è rispettivamente minore (il riuso \emph{migliora}), maggiore (\emph{peggiora}) o identico. Le tre colonne sommano sempre a 5: ad esempio, su $\kappa\approx1.1$ con $M{=}\infty$ il riuso migliora su tutti e 5 i seed per tutti gli algoritmi, mentre su $\kappa\approx20$ e $\kappa\approx100$ peggiora su tutti e 5 i seed per Newton-CG.}
