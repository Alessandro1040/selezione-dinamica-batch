...
sui quattro algoritmi implementati: Dynamic GD, Newton-CG, Newton-CG~$L_1$ e
RAPG. Per ogni iterazione il pannello riporta il numero di iterazione,
l'errore $\|w_k - w_*\|_2$ e il valore $J(w_k)$. I test sono stati eseguiti
sulle tre funzioni obiettivo quadratiche dell'applicazione: ben condizionata
...
raggruppate per funzione obiettivo, con i quattro algoritmi in ordine:
Dynamic GD, Newton-CG, Newton-CG~$L_1$, RAPG.
...
numero di iterazione, $\|w_k - w_*\|_2$ e $J(w_k)$, per i quattro algoritmi
(a) Dynamic GD, (b) Newton-CG, (c) Newton-CG~$L_1$, (d) RAPG.}
...
riportati numero di iterazione, $\|w_k - w_*\|_2$ e $J(w_k)$, per i quattro
...
iterazione, $\|w_k - w_*\|_2$ e $J(w_k)$, per i quattro algoritmi
(a) Dynamic GD, (b) Newton-CG, (c) Newton-CG~$L_1$, (d) RAPG.}
