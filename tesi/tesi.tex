...
Questa appendice riporta lo schema a blocchi del metodo aggiuntivo usato
per i test comparativi della Sezione~\ref{sec:risultati}: BB-CCV
(gradiente a campione dinamico con passo di Barzilai--Borwein).
