...
\begin{enumerate}
  \item \textbf{Analisi teorica.} Viene fornita una trattazione completa della
  ...
  condizionati.
  \item \textbf{Miglioramento dei teoremi di convergenza.} Alcuni risultati
  ...
  \item \textbf{Implementazioni.} I tre algoritmi (gradiente a campione
