...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di Newton-CG~$L_1$ sul problema ben condizionato: comportamento intermedio, senza una tendenza netta tra le politiche di riuso.
