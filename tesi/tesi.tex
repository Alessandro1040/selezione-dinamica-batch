...
\begin{center}
  ...
  \parbox{0.92\textwidth}{%
    \centering
    A chiunque mi abbia motivato a fare di più,
  }

  \vspace{0.8cm}

  % Nomi degli artisti rimossi dalla versione visibile (07/09/2026),
  % conservati qui sotto solo come riferimento storico:
