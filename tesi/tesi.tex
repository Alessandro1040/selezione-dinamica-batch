...
\end{subtable}
\end{table}
\noindent\emph{Lettura.} Stesso confronto sul problema molto mal condizionato ($\kappa\approx100$): solo BB-CCV raggiunge la precisione macchina (in 11 iterazioni), mentre Dynamic GD, Newton-CG e Newton-CG~$L_1$ restano bloccati sopra $10^{-1}$.
