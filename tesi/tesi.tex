...
BB-CCV          & 58.7\% & $3.0\times10^{-2}$ & 12\,678 & 7.1 & --- \\
\bottomrule
\end{tabular}
...
gradiente di circa due ordini di grandezza rispetto ai metodi del primo
ordine ($1.8\times10^{-3}$ contro $3$--$4\times10^{-2}$). In terzo luogo, la
