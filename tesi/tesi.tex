...
% --- Scala logaritmica globale per i colori delle tabelle della Sezione 6 ---
% min = 1.0991e-14 (Tabella 6.2, BB-CCV k=11), max = 1.4142 (punto iniziale)
\def\minLog{-13.959}   % log10(1.0991e-14)
\def\maxLog{0.1505}    % log10(1.4142)
...
codifica l'errore su una scala logaritmica globale: il verde chiaro
corrisponde all'errore più piccolo tra tutte le tabelle
($1.0991\times10^{-14}$, raggiunto da BB-CCV sul problema molto mal
condizionato, Tabella~\ref{tab:test_malcond}), il rosso scuro all'errore più
grande ($1.4142$, l'errore iniziale $\|w_0-w_*\|_2$), con gradazione continua
in mezzo.
