...
\begin{center}
  ...
  \parbox{0.92\textwidth}{%
    \centering
    Ringrazio tutte le persone con cui ho studiato, i miei insegnanti, la
  ...
  \parbox{0.92\textwidth}{%
    ...
    motivato ad andare avanti nei momenti difficili:
  }

  \vspace{0.5cm}

  Eminem, Chris Webby, Token, NF, Skylar Grey, Dope D.O.D.,\\
  Onyx, Nitro, Salmo, Mostro, SkyDxddy, Hopsin,\\
  Canibus, Madman, Gemitaiz, lowlow, Mezzosangue, Lazza,\\
  Snak The Ripper, Merkules, Ensi, Noyz Narcos, Redman, Apathy,\\
  Junk, Skrillex, Flume, JPEGMAFIA, Virus Syndicate, Black Sun Empire,\\
  Kevin Flum, Bobby Shmurda, Ro Ransom, Y2K, Denace, Fox Stevenson,\\
  Fort Minor, Alex Seaver, Sebastien Najand, Justin Tranter, JayKode,\\
  Goshfather, Jinco, Lauryn Vyce, Fall Out Boy, Jackson Breit,\\
  Jason Derulo, blackbear, Emis Killa, Europe, Twenty One Pilots,\\
  Denzel Curry, Two Feet, Sub Urban, C-Lance, Chubeats,\\
  Snowgoons, THIEVES, Scott Storch, Tyler The Creator,\\
  Requenze, Peter Piffen, Ferhatt, Hkmk, Godmode, Ren Thomas,\\
  Pop Smoke, Millyz, ANoyd, Jitta On The Track, Locksmith, NXSTY,\\
  Royce Da 5'9'', KSI, S-X, Rick Ross, Lil Baby, Russ,\\
  KXNG Crooked, Free Flow Flava, DMX, Dreamville, J.Cole, XZIBIT,\\
  Naeleck, Haley Reinhart, Jedi Mind Tricks, Bekay, Dizzy Wright,\\
  Yb Wasg'ood, Young 17, Skyder, Ice Cube, JZAC,\\
  50 Cent, Nate Dogg, Stoupe, Sik World, Oliver Anthony, Jelly Roll,
  Skrizzly Adams, Adele
\end{center}
\newpage
% ── ABSTRACT ────────────────────────────────────────────────────────────────
\begin{center}
