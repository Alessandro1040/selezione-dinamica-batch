...
\begin{itemize}
  ...
  e $1.9$, da cui $\kappa = 2.1/1.9 \approx 1.1$. Il dataset è stocastico
  centrato (Sezione~\ref{sec:architettura}): ogni perdita individuale
  $\ell(w;i)$ ha i termini quadratici centrati in un punto $(a_i,b_i)$,
  campionato con rumore $\sigma = 0.2$ attorno a $w^*=(1,-2)$ e poi ricentrato
  sulla media; anche il coefficiente dell'accoppiamento $c_i$ è campionato con
  rumore $\sigma = 0.05$.
  ...
  Sezione~\ref{app:riuso}. Il dataset è stocastico centrato
  (Sezione~\ref{sec:architettura}): ogni perdita individuale $\ell(w;i)$ ha i
  termini quadratici centrati in un punto $(a_i,b_i)$, campionato con rumore
  $\sigma = 0.2$ attorno a $w^*=(1,-2)$ e poi ricentrato sulla media.
  \item Quadratica molto mal condizionata ($\kappa \approx 100$):
  $J(w) = 100\,(w_1 - 1)^2 + (w_2 + 2)^2$ (preset ``Quadratica molto mal
  condizionata ($\kappa \approx 100$)''). Il dataset è stocastico centrato
  (Sezione~\ref{sec:architettura}): ogni perdita individuale $\ell(w;i)$ ha i
  termini quadratici centrati in un punto $(a_i,b_i)$, campionato con rumore
  $\sigma = 0.2$ attorno a $w^*=(1,-2)$ e poi ricentrato sulla media.
  ...
  $1.5$, quindi $\kappa = 2.5/1.5 \approx 1.67$. Il dataset è stocastico
  centrato (Sezione~\ref{sec:architettura}): ogni perdita individuale
  $\ell(w;i)$ ha i termini quadratici centrati in un punto $(a_i,b_i)$,
  campionato con rumore $\sigma = 0.2$ attorno a $w^*=(1,-2)$ e poi ricentrato
  sulla media; anche il coefficiente dell'accoppiamento $c_i$ è campionato con
