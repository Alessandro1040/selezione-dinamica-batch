...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di BB-CCV sul problema ben condizionato: come per Dynamic GD, il riuso migliora sistematicamente l'errore finale (5 seed su 5 con $M{=}\infty$ e $M{=}10$).
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di Dynamic GD su $\kappa\approx20$: il riuso peggiora l'errore finale rispetto alla base (con $M{=}\infty$ su tutti e 5 i seed).
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di Dynamic GD su $\kappa\approx100$: il riuso con $M{=}\infty$ peggiora l'errore finale rispetto alla base (su tutti e 5 i seed).
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di Newton-CG su $\kappa\approx100$: $M{=}\infty$ fa collassare l'errore finale ($\approx1.4$); la modalità \emph{Indipendente da $S_k$} peggiora ulteriormente la $M{=}10$ legata ($1.16$ contro $6.44\times10^{-1}$).
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di BB-CCV su $\kappa\approx100$: il riuso peggiora l'errore finale rispetto alla base, come sugli altri problemi mal condizionati.
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di Newton-CG sul termine incrociato: il riuso illimitato ($M{=}\infty$) fa collassare la convergenza; la modalità \emph{Indipendente da $S_k$} (ultima colonna) migliora la colonna $M{=}10$ legata.
