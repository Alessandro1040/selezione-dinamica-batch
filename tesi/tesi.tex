...
Newton-CG, Newton-CG~$L_1$ e BB-CCV (Sezione~\ref{sec:bbccv}); i valori sono
quelli del pannello ``Analisi'' dell'applicazione. Le versioni \emph{base}
(ricampionamento a ogni iterazione) degli stessi algoritmi ricompaiono, con i
valori completi per tutti i problemi, nelle tabelle di sintesi
dell'esperimento di riuso (Sezione~\ref{app:riuso},
Tabella~\ref{tab:riuso_sintesi}).
