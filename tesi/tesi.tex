...
\begin{tikzpicture}[
  ...
  % Firma
  \node[io, text width=6.4cm] (sig) at (0, 3.6) {Firma: \texttt{estrai\_chroma}(clip)\\[2pt] $\to x_i \in \mathbb{R}^{24}$};
...
\begin{tikzpicture}[
  ...
  % Firma
  \node[io, text width=6.8cm] (sig) at (0, 3.6) {Firma: \texttt{costruisci\_dati}(split)\\[2pt] $\to (X,\; y)$};
...
\begin{tikzpicture}[
  ...
  % Firma
  \node[io, text width=6.4cm] (sig) at (0, 3.6) {Firma: \texttt{grad\_i}($w$, $i$)\\[2pt] $\to \nabla \ell_i(w) \in \mathbb{R}^{300}$};
...
\begin{tikzpicture}[
  ...
  % Firma
  \node[io, text width=6.6cm] (sig) at (0, 3.6) {Firma: \texttt{hessvec\_i}($w$, $i$, $v$)\\[2pt] $\to \nabla^2 \ell_i(w)\, v$};
...
\begin{tikzpicture}[
  ...
  % Firma
  \node[io, text width=6.8cm] (sig) at (0, 3.6) {Firma: \texttt{grad\_full}($w$)\\[2pt] $\to \nabla J(w)$ (su tutto il training set, vettorizzato)};
