...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di BB-CCV sul problema ben condizionato (seed 42): come per Dynamic GD, il riuso migliora l'errore finale; la conferma su 5 seed (5/5 con $M{=}\infty$ e $M{=}10$) è nella Tabella~\ref{tab:riuso_robustezza}.
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di BB-CCV su $\kappa\approx20$: il riuso peggiora l'errore finale rispetto alla base, per la deriva verso il minimo campionario.
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di BB-CCV su $\kappa\approx100$ (seed 42): come per Dynamic GD, il riuso con $M{=}\infty$ migliora l'errore finale ($3.71\times10^{-1}$ contro $4.67\times10^{-1}$ della base).
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Errore a ogni iterazione di BB-CCV sul termine incrociato: la colonna \emph{base} è il riferimento senza riuso, le altre il riuso dello stesso batch per $M$ iterazioni. Con $M{=}\infty$ il riuso aiuta l'errore finale, come per Dynamic GD.
...
incrociato ($\kappa\approx1.67$) - BB-CCV &\colorcell{9.42}{-3}&\colorcell{5.53}{-3}$\blacktriangle$&\colorcell{9.96}{-3}$\blacktriangledown$&\colorcell{5.95}{-3}$\blacktriangle$&\colorcell{7.58}{-3}$\blacktriangle$&\colorcell{8.72}{-3}$\blacktriangle$&\colorcell{9.42}{-3}$=$\\
...
\end{table}
\noindent\emph{Lettura.} Tabella di sintesi dell'esperimento di riuso: errore finale $e_{30}$ (seed 42) per tutti i valori di $M\in\{\infty,10,5,3,2,1\}$ su tutte le coppie problema$\times$algoritmo. Si legge per individuare dove il riuso aiuta (ben condizionato e termine incrociato) e dove peggiora (mal condizionati, e metodi di Newton con $M{=}\infty$).
...
incrociato ($\kappa\approx1.67$) - BB-CCV &\colorcell{1.87}{-2} (29)&\colorcell{1.73}{-2}$\blacktriangle$ (16)&\colorcell{1.73}{-2}$\blacktriangle$ (16)&\colorcell{6.15}{-3}$\blacktriangle$ (16)&\colorcell{6.24}{-3}$\blacktriangle$ (15)\\
...
Pazienza $P$ & 3 &\colorcell{2.98}{-1}& 9.9\\
Pazienza $P$ & 8 &\colorcell{3.45}{-1}& 9.3\\
\midrule
Tolleranza $\tau$ & $10^{-5}$ &\colorcell{3.02}{-1}& 10.7\\
Tolleranza $\tau$ & $10^{-4}$ &\colorcell{3.02}{-1}& 10.7\\
Tolleranza $\tau$ & $10^{-3}$ &\colorcell{3.02}{-1}& 10.7\\
\midrule
Percentuale $p$ & 10\% &\colorcell{2.70}{-1}& 11.2\\
Percentuale $p$ & 20\% &\colorcell{3.06}{-1}& 10.1\\
Percentuale $p$ & 30\% &\colorcell{3.30}{-1}& 10.7\\
\midrule
Frequenza $f$ & 1 &\colorcell{2.76}{-1}& 11.5\\
Frequenza $f$ & 3 &\colorcell{3.28}{-1}& 9.8\\
\midrule
Strategia di split & \emph{fisso} &\colorcell{3.21}{-1}& 10.9\\
Strategia di split & \emph{dinamico} &\colorcell{2.83}{-1}& 10.5\\
\midrule
\bottomrule
\end{tabular}
\end{table}
...
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Robustezza su 5 seed: la calibrazione $P{=}1,p{=}0.1$,dyn porta l'errore medio a $2.24\times10^{-1}$, inferiore a quello della base ($2.47\times10^{-1}$) e di $M{=}\infty$ ($4.29\times10^{-1}$), vincendo in 11 combinazioni su 16.
...
l'iperparametro più influente ($P=1$ riduce l'errore medio di circa il 21\%
rispetto a $P=8$, $2.61\times10^{-1}$ contro $3.30\times10^{-1}$, con pochi
ricampionamenti in più: 11.1 contro 10.2 su 30 iterazioni); la tolleranza è
...
($2.67\times10^{-1}$ contro $3.15\times10^{-1}$).
...
\caption{Riuso per discesa della loss sul batch: errore finale $e_{30}=\|w_{30}-w_*\|_2$ (seed 42) per i quattro problemi e i quattro algoritmi. Colonne: \emph{base} = ricampionamento a ogni iterazione; $M{=}\infty$ = riuso illimitato; \emph{def.} = valori di default del criterio di discesa ($\tau=10^{-4}$, $P=1$, $f=1$, soglia assoluta 0); $P{=}1,\tau{=}10^{-3}$ e $P{=}1,\tau{=}10^{-5}$ (in entrambe $f{=}1$) = migliori configurazioni dello sweep (media di $e_{30}$ su 16 combinazioni problema$\times$algoritmo). Tra parentesi il numero di ricampionamenti del mini-batch nelle 30 iterazioni. Tutte le colonne campionano dall'intero dataset (nessun validation set). Simboli relativi a \emph{base}: $\blacktriangle$ = migliora, $\blacktriangledown$ = peggiora, $=$ = invariato.}
\label{tab:riuso_desc_confronto}
\begin{tabular}{@{}lrrrrrr@{}}
\toprule
Metodo & \emph{base} & $M{=}\infty$ & def. & $P{=}1,\tau{=}10^{-3}$ & $P{=}1,\tau{=}10^{-5}$\\
\midrule
...
$\kappa\approx1.1$ - BB-CCV & \colorcell{1.19}{-1} (29) & \colorcell{1.17}{-1}$\blacktriangle$ (18) & \colorcell{1.17}{-1}$\blacktriangle$ (18) & \colorcell{1.17}{-1}$\blacktriangle$ (18) & \colorcell{1.17}{-1}$\blacktriangle$ (18)\\
...
$\kappa\approx20$ - BB-CCV & \colorcell{4.91}{-2} (29) & \colorcell{1.01}{-1}$\blacktriangledown$ (1) & \colorcell{1.01}{-1}$\blacktriangledown$ (1) & \colorcell{4.89}{-2}$\blacktriangle$ (14) & \colorcell{1.01}{-1}$\blacktriangledown$ (1)\\
...
$\kappa\approx100$ - BB-CCV & \colorcell{4.67}{-1} (29) & \colorcell{3.71}{-1}$\blacktriangle$ (27) & \colorcell{3.71}{-1}$\blacktriangle$ (27) & \colorcell{3.71}{-1}$\blacktriangle$ (27) & \colorcell{3.71}{-1}$\blacktriangle$ (27)\\
...
incrociato ($\kappa\approx1.67$) - BB-CCV & \colorcell{9.42}{-3} (29) & \colorcell{5.53}{-3}$\blacktriangle$ (16) & \colorcell{5.53}{-3}$\blacktriangle$ (16) & \colorcell{5.53}{-3}$\blacktriangle$ (16) & \colorcell{5.53}{-3}$\blacktriangle$ (16)\\
...
Iperparametro & Valore & $\overline{e}_{30}$ & ricampionamenti medi\\
\midrule
Pazienza $P$ & 1 & \colorcell{2.61}{-1} & 11.1\\
Pazienza $P$ & 3 & \colorcell{2.82}{-1} & 10.5\\
Pazienza $P$ & 8 & \colorcell{3.30}{-1} & 10.2\\
\midrule
Tolleranza $\tau$ & $10^{-5}$ & \colorcell{2.92}{-1} & 10.5\\
Tolleranza $\tau$ & $10^{-4}$ & \colorcell{2.92}{-1} & 10.5\\
Tolleranza $\tau$ & $10^{-3}$ & \colorcell{2.90}{-1} & 10.8\\
\midrule
Frequenza $f$ & 1 & \colorcell{2.67}{-1} & 10.9\\
Frequenza $f$ & 3 & \colorcell{3.15}{-1} & 10.2\\
\midrule
\bottomrule
\end{tabular}
\end{table}
...
Configurazione & $\overline{e}_{30}$ & \emph{vitt.} & $\kappa{\approx}1.1$ & $\kappa{\approx}20$ & $\kappa{\approx}100$ & incr. ($\kappa{\approx}1.67$)\\
\midrule
\emph{base} & \colorcell{2.43}{-1} & 0/16 & \colorcell{1.80}{-1} & \colorcell{1.89}{-1} & \colorcell{5.18}{-1} & \colorcell{8.39}{-2}\\
$M{=}\infty$ & \colorcell{3.95}{-1} & 8/16 & \colorcell{1.91}{-1} & \colorcell{5.20}{-1} & \colorcell{7.69}{-1} & \colorcell{1.00}{-1}\\
\midrule
def. & \colorcell{2.35}{-1} & 10/16 & \colorcell{1.18}{-1} & \colorcell{2.59}{-1} & \colorcell{5.24}{-1} & \colorcell{3.58}{-2}\\
$P{=}1,\tau{=}10^{-3}$ & \colorcell{2.31}{-1} & 12/16 & \colorcell{1.18}{-1} & \colorcell{2.46}{-1} & \colorcell{5.24}{-1} & \colorcell{3.58}{-2}\\
$P{=}1,\tau{=}10^{-5}$ & \colorcell{2.35}{-1} & 10/16 & \colorcell{1.18}{-1} & \colorcell{2.59}{-1} & \colorcell{5.24}{-1} & \colorcell{3.58}{-2}\\
\bottomrule
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Robustezza su 5 seed: la configurazione consigliata ($\tau{=}10^{-3}$, $P{=}1$, $f{=}1$) porta l'errore medio a $2.31\times10^{-1}$, inferiore a quello della base ($2.43\times10^{-1}$) e di $M{=}\infty$ ($3.95\times10^{-1}$), con 12 vittorie su 16 combinazioni problema$\times$algoritmo.
...
per Dynamic GD e BB-CCV la monotonia della ricerca lineare mantiene il batch
...
fallisce riporta i metodi del primo ordine vicino alla \emph{base} (su
...
$2.31\times10^{-1}$, inferiore a quello della \emph{base}
($2.43\times10^{-1}$) e di $M=\infty$ ($3.95\times10^{-1}$), vincendo in 12
delle 16 combinazioni problema$\times$algoritmo. Il default
($\tau=10^{-4}$, $P=1$, $f=1$) è leggermente peggiore
($2.35\times10^{-1}$, 10/16): la tolleranza di default è troppo stretta
perché i metodi del primo ordine vengano riconosciuti ``esauriti''.
...
la \emph{base} (in 11/16 caselle la validation, in 12/16 la discesa,
...
$M=\infty$. In media la validation è leggermente migliore
($2.24\times10^{-1}$ contro $2.31\times10^{-1}$), ma paga il costo di tenere
fuori dal campionamento il $10\%$ dei dati; il criterio di discesa usa
l'intero dataset, non richiede split né validation set ed è più semplice da
applicare. Su $\kappa\approx20$, il problema su cui $M=\infty$ è più
pericoloso, i due criteri sono entrambi efficaci ($2.28\times10^{-1}$ e
$2.46\times10^{-1}$ contro $1.89\times10^{-1}$ della \emph{base} e
$5.20\times10^{-1}$ di $M=\infty$).
...
e protezione dal collasso di $M=\infty$ per i metodi del secondo ordine. Va
però calibrata la tolleranza ($\tau=10^{-3}$ invece del default $10^{-4}$),
perché la monotonia della ricerca lineare rende il criterio poco sensibile
con soglie troppo strette.
...
\midrule
$P{=}1,p{=}0.1$,dyn & \colorcell{2.24}{-1} & 11/16 & \colorcell{1.41}{-1} & \colorcell{2.28}{-1} & \colorcell{4.84}{-1} & \colorcell{4.15}{-2}\\
$\tau{=}10^{-3},P{=}1,f{=}1$ & \colorcell{2.31}{-1} & 12/16 & \colorcell{1.18}{-1} & \colorcell{2.46}{-1} & \colorcell{5.24}{-1} & \colorcell{3.58}{-2}\\
\bottomrule
\end{tabular}
\end{table}
\noindent\emph{Lettura.} Chiude il confronto tra i due criteri automatici su 5 seed: la validation calibrata è leggermente migliore in media ($2.24\times10^{-1}$ contro $2.31\times10^{-1}$) ma tiene fuori il 10\% dei dati; la discesa usa l'intero dataset, non richiede split né validation set ed è più semplice da applicare.
