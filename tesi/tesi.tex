...
spostare l'errore finale di pochi punti percentuali. Gli script di generazione
del repository (eseguiti con il NumPy di sistema) restano quindi il
riferimento per la riproduzione esatta delle tabelle.
