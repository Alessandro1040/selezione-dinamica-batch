...
Barzilai--Borwein stima la curvatura usando solo i gradienti già calcolati e
non richiede la Hessiana: è particolarmente efficace proprio sui problemi mal
...
è il metodo che performa meglio in assoluto sui problemi considerati, in
...
\textbf{L'espansione di Taylor del gradiente.} Consideriamo due iterazioni
...
\textbf{Spostamento e variazione del gradiente.} Per rendere la scrittura più
...
\textbf{La relazione tra Hessiana e dati osservati.} Sostituendo le
...
\textbf{Il collegamento con i metodi quasi Newton.} Calcolare esplicitamente
...
\textbf{Le due formule di Barzilai--Borwein.} Dalla relazione
...
\textbf{Un metodo quasi Newton senza memoria.} A differenza degli altri metodi
...
\textbf{Il caso quadratico è il caso ideale.} L'approssimazione
...
\textbf{I limiti sulle funzioni non quadratiche.} Quando $J$ non è quadratica
...
\textbf{Sintesi.} Il passo di Barzilai--Borwein è la soluzione analitica
