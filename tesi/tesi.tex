...
\begin{itemize}
  ...
  centrato (Sezione~\ref{sec:architettura}), con rumore $\sigma = 0.2$ sulle
  coordinate $a_i, b_i$ e rumore $\sigma = 0.05$ sul coefficiente
  dell'accoppiamento $c_i$.
  ...
  (Sezione~\ref{sec:architettura}), con rumore $\sigma = 0.2$ sulle coordinate
  $a_i, b_i$.
