...
\begin{itemize}
  ...
  $\sigma = 0.2$ (varianza $\sigma^2 = (0.2)^2$), mentre $c_i$ ha media $0.1$ e
  deviazione standard $0.05$ (varianza $(0.05)^2$); i valori sono poi ricentrati
  sulla media campionaria (dataset ``centrato'',
  ...
  $\sigma = 0.2$ (varianza $\sigma^2 = (0.2)^2$); i valori sono poi ricentrati
  sulla media campionaria (dataset ``centrato'',
  Sezione~\ref{sec:architettura}).
  ...
  deviazione standard $\sigma = 0.2$ (varianza $\sigma^2 = (0.2)^2$), mentre
  $c_i$ ha media $0.5$ e deviazione standard $0.05$ (varianza $(0.05)^2$); i
