...
Questa appendice riporta i risultati dei test comparativi eseguiti con il
pannello ``Analisi'' dell'applicazione interattiva
(Sezione~\ref{sec:visualizzazione}) sui cinque algoritmi dell'applicazione:
Dynamic GD, Newton-CG, Newton-CG~$L_1$, RAPG e BB-CCV
(Appendice~\ref{app:bbccv}). Per ogni iterazione $k$ il pannello riporta la
norma dell'errore $\|w_k-w_*\|_2$. I test sono stati eseguiti sulle tre
...
termine incrociato. Le Tabelle~F.1--F.3 riportano $\|w_k-w_*\|_2$ a ogni
iterazione, con i cinque algoritmi affiancati in ordine: (a)~Dynamic GD,
(b)~Newton-CG, (c)~Newton-CG~$L_1$, (d)~RAPG, (e)~BB-CCV.

% Tabella F - quadratico ben condizionato ($\kappa \approx 1.1$)
\begin{table}[H]
\centering
\footnotesize
\renewcommand{\arraystretch}{0.85}
\setlength{\tabcolsep}{3pt}
\caption{Errore $\|w_k-w_*\|_2$ a ogni iterazione sul problema quadratico ben condizionato ($\kappa \approx 1.1$), per i cinque algoritmi. I valori sono quelli riportati dal pannello \emph{Analisi} dell'applicazione (Sezione~\ref{sec:visualizzazione}).}
...
% Tabella F - quadratico molto mal condizionato ($\kappa \approx 100$)
\begin{table}[H]
\centering
\footnotesize
\renewcommand{\arraystretch}{0.85}
\setlength{\tabcolsep}{3pt}
\caption{Errore $\|w_k-w_*\|_2$ a ogni iterazione sul problema quadratico molto mal condizionato ($\kappa \approx 100$), per i cinque algoritmi. I valori sono quelli riportati dal pannello \emph{Analisi} dell'applicazione (Sezione~\ref{sec:visualizzazione}).}
...
% Tabella F - quadratico con termine incrociato
\begin{table}[H]
\centering
\footnotesize
\renewcommand{\arraystretch}{0.85}
\setlength{\tabcolsep}{3pt}
\caption{Errore $\|w_k-w_*\|_2$ a ogni iterazione sul problema quadratico con termine incrociato, per i cinque algoritmi. I valori sono quelli riportati dal pannello \emph{Analisi} dell'applicazione (Sezione~\ref{sec:visualizzazione}).}
...
\paragraph{Osservazioni comparative.} Dai valori delle Tabelle~F.1--F.3 emergono le seguenti
...
converge alla precisione macchina ($\|w-w_*\| \approx 10^{-14}$) in 11
