...
\frontmatter
% Nel frontespizio si evita il \cleardoublepage (niente versi bianchi tra i
% blocchi, come nell'attuale tesi_finale.pdf); lo si ripristina per il mainmatter.
\makeatletter
\let\SAP@save@cleardoublepage\cleardoublepage
...
\tableofcontents
\makeatletter
\let\cleardoublepage\SAP@save@cleardoublepage
\makeatother
\mainmatter
